...
class TripsLayer(BaseArrowLayer):
    ...
    [`from_movingpandas`][lonboard.TripsLayer.from_movingpandas]
    ...
    In order to animate this layer, call the [`animate`][lonboard.TripsLayer.animate]
    method.

    !!! warning

        The TripsLayer renders data representing a specific instance in time based on
        the [`current_time`][lonboard.TripsLayer.current_time] attribute.

        If you don't see any data, use the [`animate`][lonboard.TripsLayer.animate]
    ...
    !!! info "Passing in custom Arrow data"
        ...
        [`get_timestamps`][lonboard.TripsLayer.get_timestamps] accessor needs to be an
    ...
    width_scale = t.Float(default_value=None, allow_none=True, min=0).tag(
        sync=True,
    )
    """
    ...
    width_min_pixels = t.Float(default_value=None, allow_none=True, min=0).tag(
        sync=True,
    )
    """
    ...
    width_max_pixels = t.Float(default_value=None, allow_none=True, min=0).tag(
        sync=True,
    )
    """
    ...
    - Type: `float`, optional
    - Default: set by the [`animate`][lonboard.TripsLayer.animate] method.
    ...
    get_timestamps = t.TimestampAccessor(None, allow_none=True)
    """
    ...
    def from_movingpandas(
        ...
        **kwargs: Unpack[TripsLayerKwargs],
        ...
        """Construct a TripsLayer from a MovingPandas [`TrajectoryCollection`][movingpandas.TrajectoryCollection].
    ...
    def animate(
        ...
        *,
        ...
        """Animate this layer with an [`ipywidgets.Play`][ipywidgets.widgets.widget_int.Play] controller.
        ...
        def update_timestamp_output(change: dict[str, Any]) -> None:
    ...
    def stop_animation(self) -> None:
        ...
        To reanimate the map, call [`animate`][lonboard.TripsLayer.animate]
        again.
        """
